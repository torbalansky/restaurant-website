...
const MenuData = [
  { id: 1, name: "Паея с морски дарове", price: "12,50 лв.", img: paellaImg, ingredients: "Ориз, морски дарове (миди, калмари, скариди), домати, червен пипер, чесън, лук, маслинено масло, бяло вино, лимон", allergens: "Миди", quantity: "350 гр.", description: "Традиционна испанска паеля, приготвена с разнообразие от морски дарове, в ароматен оризов сос, с добавка на домати и червен пипер." },
